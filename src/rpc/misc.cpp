...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total MIL balance of the wallet\n"
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"miladdress\"\n"
            "\nReturn information about the given MIL address.\n"
            "\nArguments:\n"
            "1. \"miladdress\"     (string, required) The MIL address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"miladdress\", (string) The MIL address validated\n"
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
    {
        string msg = "createmultisig nrequired [\"key\",...]\n"
            ...
            "2. \"keys\"       (string, required) A json array of keys which are MIL addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) MIL address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
            ...
            + HelpExampleCli("createmultisig", "2 \"[\\\"EknqTC9XEuUcZehD3MiDGnbJxBptcXhbyA\\\",\\\"LbhhnRHHVfP1eUJp1tDNiyeeVsNhFN9Fcw\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("createmultisig", "2, \"[\\\"EknqTC9XEuUcZehD3MiDGnbJxBptcXhbyA\\\",\\\"LbhhnRHHVfP1eUJp1tDNiyeeVsNhFN9Fcw\\\"]\"")
        ;
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"miladdress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"miladdress\"  (string, required) The MIL address to use for the signature.\n"
...
UniValue getaddressbalance(const UniValue& params, bool fHelp)
{
    ...
    if(!getAddressesFromParams(params,addresses)){
        throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY,"Invalid adress");
    } 
